App = {
     ...
     initContract: function() {
       $.getJSON('Chainlist.json', function(chainListArtifact) {
         //get the contract artifact file and use it to instantiate a tuffle contract abstraction
         App.contracts.Chainlist = TruffleContract(chainListArtifact);
         //set the proivider for our contracts
     ...
     sellArticle: function() {
       ...
       var _price = web3.toWei(parseFloat($('#article_price').val()));
