...
contract("Chainlist", function(accounts) {
  ...
  // incorrect value
  it("should throw an exception if you try to buy an own article for a value different from its price", function(){
    return Chainlist.deployed().then(function(instance){
      chainListInstance = instance;
  ...
  it("should throw an exception if you try to buy an own article that was already sold", function(){
    return Chainlist.deployed().then(function(instance){
      chainListInstance = instance;
