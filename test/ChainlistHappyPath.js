...
contract('Chainlist', function(accounts){
  ...
  it("should let us sell a second article", function(){
    return Chainlist.deployed().then(function(instance){
      ...
      assert.equal(receipt.logs[0].args._price.toNumber(), web3.toWei(articlePrice2, "ether"), "event price must be " + web3.toWei(articlePrice1, "ether"));
  ...
  it("should buy an article", function(){
    return Chainlist.deployed().then(function(instance){
      ...
      //check the effect of buy on the balances of seller and buyer, accounting for gas
